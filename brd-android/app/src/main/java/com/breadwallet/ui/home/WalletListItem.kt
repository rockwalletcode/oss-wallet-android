...
class WalletListItem(
    ...
    class ViewHolder(
        ...
        override fun bindView(item: WalletListItem, payloads: List<Any>) {
            ...
            val exchangeRate = wallet.fiatPricePerUnit.formatFiatForUiAdvanced(preferredFiatIso)
            val fiatBalance = wallet.fiatBalance.formatFiatForUiAdvanced(preferredFiatIso)
