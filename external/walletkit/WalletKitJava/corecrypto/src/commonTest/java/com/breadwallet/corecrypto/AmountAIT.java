...
public class AmountAIT {
    ...
    private void assertMultiple (String value, String... values) {
    ...
    public void testAmountCreateBtc() {
        ...
        assertMultiple (btc4.toStringAsUnit(btc_btc, null).get(), "-B1.50", "(B1.50)");
        assertMultiple (btc4.toStringAsUnit(satoshi_btc, null).get(), "-SAT150,000,000", "(SAT150,000,000)");
    ...
    public void testAmountCreateBtcString() {
        ...
        assertMultiple(btc4s.toStringAsUnit(satoshi_btc, null).get(), "-SAT100,000,000", "(SAT100,000,000)");
        assertMultiple(btc4s.toStringAsUnit(btc_btc, null).get(),"-B1.00", "(B1.00)");
